function Skill(props) {
  ...
  const bgcolor = {
    ...
    yellow: 'bg-gradient-to-r from-yellow-500 to-yellow-900   ',
    pink: 'bg-gradient-to-r from-pink-500 to-pink-900   ',
    orange: 'bg-gradient-to-r from-orange-500 to-orange-900   ',
    purple: 'bg-gradient-to-r from-purple-500 to-purple-900   ',
    cyan: 'bg-gradient-to-r from-cyan-500 to-cyan-900   ',
    violet: 'bg-gradient-to-r from-violet-500 to-violet-900   ',
    slate: 'bg-gradient-to-r from-slate-500 to-slate-900   ',
    sky: 'bg-gradient-to-r from-sky-500 to-sky-900   ',
    indigo: 'bg-gradient-to-r from-indigo-500 to-indigo-900   ',
    fuchsia: 'bg-gradient-to-r from-fuchsia-500 to-fuchsia-900   ',
    gray: 'bg-gradient-to-r from-gray-500 to-gray-900   ',
    emerald: 'bg-gradient-to-r from-emerald-500 to-emerald-900   ',
  };
  const hoverColor = {
  ...
  return (
    <div
      className={`${bgcolor[color]} ${hoverColor[color]} active:animate-pulse hover:-translate-y-1 ease-in-out duration-200 px-4 py-8 shadow-lg rounded-full`}
    >
      {props.name}
    </div>
  );
